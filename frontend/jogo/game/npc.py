...
class NPC(AnimatedSprite):
	def __init__(self, game, path='frontend/jogo/game/resources/sprites/npc/soldier/0.png', pos=(10.5, 5.5),
	...
	def check_health(self):
		if self.health < 1:
			...
			self.game.player.add_npc_kill_points(self.map_pos)
...
class CacoDemonNPC(NPC):
    def __init__(self, game, path='frontend/jogo/game/resources/sprites/npc/caco_demon/0.png', pos=(10.5, 6.5),
...
class CyberDemonNPC(NPC):
    def __init__(self, game, path='frontend/jogo/game/resources/sprites/npc/cyber_demon/0.png', pos=(11.5, 6.0),
