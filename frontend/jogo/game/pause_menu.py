...
class PauseMenu:
    def __init__(self, game):
        ...
        self.title_font = pg.font.Font('frontend/jogo/game/fonts/titulo.ttf', 74)
        self.main_font = pg.font.Font('frontend/jogo/game/fonts/resto.ttf', 36)
        self.small_font = pg.font.Font('frontend/jogo/game/fonts/resto.ttf', 24)
